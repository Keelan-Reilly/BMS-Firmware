...
{
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_5,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL},		// POWER_ENABLE
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_4,GPIO_MODE_INPUT,GPIO_PULLUP},				// POWER_BUTTON
#ifdef HWVersion_0_4	
	{GPIOC,RCC_AHBENR_GPIOCEN,GPIO_PIN_14,GPIO_MODE_INPUT,GPIO_PULLUP}				// CHARGE_DETECT
#else  																																			// Any other previous version
	{GPIOA,RCC_AHBENR_GPIOCEN,GPIO_PIN_0,GPIO_MODE_INPUT,GPIO_PULLUP}					// CHARGE_DETECT
#endif
};
